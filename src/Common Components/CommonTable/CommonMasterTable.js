...
export default function CommonMasterTable(props) {
  ...
  const [nextBtnVisibilty, setNextBtnVisibilty] = React.useState(false);
            ...
            labelRowsPerPage={
              <>
                <span style={{ marginRight: "10px", color: "blue" }}>
                  <span>
                    <a href="#" onClick={props.DownloadTemplateData}>
                      Download Template
                    </a>
                  </span>
                  ...
                  <span>
                    <a href="#" onClick={props.ExportData}>
                      Export Data
                    </a>
                  </span>
                </span>
